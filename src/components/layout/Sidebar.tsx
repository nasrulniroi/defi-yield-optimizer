    ...
    >
      <div className="flex items-center h-16 px-4 border-b border-surface-700/50">
        <div className="flex items-center space-x-3">
          ...
          {!collapsed && (
            <div>
              <h1 className="text-sm font-bold gradient-text">DeFi Optimizer</h1>
              <p className="text-xs text-surface-200">Yield Maximizer</p>
            </div>
          )}
        </div>
      </div>
      ...
      <nav className="flex-1 px-3 py-4 space-y-1">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <span className={clsx(isActive ? 'text-primary-400' : 'text-surface-200 group-hover:text-white')}>
                {item.icon}
              </span>
              {!collapsed && (
      ...
      <div className="p-4 border-t border-surface-700/50">
        <button
          ...
          className="w-full flex items-center justify-center px-3 py-2 text-surface-200 hover:text-white hover:bg-surface-700/50 rounded-xl transition-all"
        >
          <svg
